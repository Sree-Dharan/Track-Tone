# Generated by Django 4.2.10 on 2024-04-16 09:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workout_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gym_mgt.workoutplan')),
            ],
        ),
        migrations.CreateModel(
            name='Shipment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField()),
                ('end_date', models.DateField()),
                ('membership_type', models.CharField(choices=[('Bronze', 'Bronze'), ('Silver', 'Silver'), ('Gold', 'Gold'), ('Platinum', 'Platinum')], max_length=20)),
                ('trainee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_of_week', models.CharField(choices=[('Sunday', 'Sunday'), ('Monday', 'Monday'), ('Tuesday', 'Tuesday'), ('Wednesday', 'Wednesday'), ('Thursday', 'Thursday'), ('Friday', 'Friday'), ('Saturday', 'Saturday')], max_length=9)),
                ('morning', models.CharField(blank=True, max_length=50)),
                ('afternoon', models.CharField(blank=True, max_length=50)),
                ('evening', models.CharField(blank=True, max_length=50)),
                ('diet_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gym_mgt.dietplan')),
            ],
        ),
    ]
